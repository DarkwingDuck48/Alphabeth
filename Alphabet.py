...
class Bashkir(Alphabet):
    def __init__(self):
        self.name = "Bashkir"
        self.chartype = "Letters"
        self.description = ("Современный башкирский алфавит утверждён в 1939 году. Введён в употребление годом позже. В 1950 в него была добавлена буква Ё, и он стал таким, какой он сейчас. башкирский алфавит составлен на основе кириллицы, но дополнен девятью буквами для передачи специфичных звуков башкирского языка. Всего содержит 42 буквы, две из которых уникальны, то есть, их нет больше ни в одной письменности.В древние времена, башкиры пользовались древнетюркским руническим письмом. Затем, с Х века, по мере распространения ислама – писали на арабском. С XIII по XIX века вели записи применяя старотюркский письменно-литературный язык. Он тоже был основан на арабском письме. В XIX – ХХ веках было насколько попыток создать национальный башкирский алфавит. Однако, ни одна из этих письменностей не использовалась достаточно долго.")
